...
class ButtonWidget extends StatelessWidget with Utility, NavigationMixin, ContainerMixin {
  ...
  Widget build(BuildContext context) {
    ...
    String textTitle = ConvertData.textFromConfigs(title, settingStore.languageKey);
