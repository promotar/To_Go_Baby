...
AddressBookData _$AddressBookDataFromJson(Map<String, dynamic> json) => AddressBookData(
      name: json['book_name'] as String?,
      address: json['book_address'] as String?,
      data: AddressBookData._toMapString(json['data']),
    );

Map<String, dynamic> _$AddressBookDataToJson(AddressBookData instance) => <String, dynamic>{
