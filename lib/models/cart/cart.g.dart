...
CartData _$CartDataFromJson(Map<String, dynamic> json) => CartData(
      ...
      ..shippingRate = CartData._fromShippingRate(json['shipping_rates'] as List?)
...
CartItem _$CartItemFromJson(Map<String, dynamic> json) => CartItem(
      ...
      quantityLimit: json['quantity_limits'] == null
          ? null
          : QuantityLimit.fromJson(json['quantity_limits'] as Map<String, dynamic>),
      name: json['name'] as String?,
...
QuantityLimit _$QuantityLimitFromJson(Map<String, dynamic> json) => QuantityLimit(
      minimum: json['minimum'] as int? ?? 1,
      maximum: json['maximum'] as int?,
      step: json['multiple_of'] as int? ?? 1,
    );

Map<String, dynamic> _$QuantityLimitToJson(QuantityLimit instance) => <String, dynamic>{
