...
BPMember _$BPMemberFromJson(Map<String, dynamic> json) => BPMember(
      ...
      friendshipStatusSlug: BPMember._fromFriendshipSlug(json['friendship_status_slug']),
...
BPMemberProfile _$BPMemberProfileFromJson(Map<String, dynamic> json) => BPMemberProfile(
      id: json['id'] as int?,
      name: json['name'] as String?,
      fields: BPMemberProfile._fromField(json['fields']),
    );

Map<String, dynamic> _$BPMemberProfileToJson(BPMemberProfile instance) => <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
      'fields': BPMemberProfile._toField(instance.fields),
    };

BPMemberProfileField _$BPMemberProfileFieldFromJson(Map<String, dynamic> json) => BPMemberProfileField(
      id: json['id'] as int?,
      name: json['name'] as String?,
      value: BPMemberProfileField._fromValue(json['value']),
    );

Map<String, dynamic> _$BPMemberProfileFieldToJson(BPMemberProfileField instance) => <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
