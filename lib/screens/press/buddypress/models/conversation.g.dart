...
BPConversation _$BPConversationFromJson(Map<String, dynamic> json) => BPConversation(
      id: json['id'] as int?,
      ...
      starredMessageIds: BPConversation._fromStarredMessageIds(json['starred_message_ids']),
