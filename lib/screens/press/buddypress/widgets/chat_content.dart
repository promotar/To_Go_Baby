...
class _ChatContentWidgetState extends State<ChatContentWidget> with LoadingMixin {
  ...
  Widget build(BuildContext context) {
    ...
    ChatTheme chatTheme = DefaultChatTheme(
      ...
      sentMessageCaptionTextStyle: theme.textTheme.titleSmall?.copyWith(color: theme.colorScheme.onPrimary) ??
          TextStyle(color: theme.colorScheme.onPrimary),
      sentMessageBodyTextStyle: theme.textTheme.bodyMedium?.copyWith(color: theme.colorScheme.onPrimary) ??
          TextStyle(color: theme.colorScheme.onPrimary),
      sentMessageLinkTitleTextStyle: theme.textTheme.titleMedium?.copyWith(color: theme.colorScheme.onPrimary) ??
          TextStyle(color: theme.colorScheme.onPrimary),
      sentMessageLinkDescriptionTextStyle: theme.textTheme.bodyMedium?.copyWith(color: theme.colorScheme.onPrimary) ??
          TextStyle(color: theme.colorScheme.onPrimary),
