...
class _UpdateActivityGroupFormWidgetState extends State<UpdateActivityGroupFormWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: baseStyleAppBar(context, title: translate("buddypress_group_update_activity")),
