...
mixin _$BPMemberGroupStore on BPMemberGroupStoreBase, Store {
  ...
  @override
  bool get loading =>
      (_$loadingComputed ??= Computed<bool>(() => super.loading, name: 'BPMemberGroupStoreBase.loading')).value;
  Computed<int>? _$nextPageComputed;

  @override
  int get nextPage =>
      (_$nextPageComputed ??= Computed<int>(() => super.nextPage, name: 'BPMemberGroupStoreBase.nextPage')).value;
  Computed<ObservableList<BPMemberGroup>>? _$membersComputed;

  @override
  ObservableList<BPMemberGroup> get members => (_$membersComputed ??=
          Computed<ObservableList<BPMemberGroup>>(() => super.members, name: 'BPMemberGroupStoreBase.members'))
      .value;
  Computed<bool>? _$canLoadMoreComputed;

  @override
  bool get canLoadMore =>
      (_$canLoadMoreComputed ??= Computed<bool>(() => super.canLoadMore, name: 'BPMemberGroupStoreBase.canLoadMore'))
          .value;
  Computed<int>? _$perPageComputed;

  @override
  int get perPage =>
      (_$perPageComputed ??= Computed<int>(() => super.perPage, name: 'BPMemberGroupStoreBase.perPage')).value;
  Computed<String>? _$searchComputed;

  @override
  String get search =>
      (_$searchComputed ??= Computed<String>(() => super.search, name: 'BPMemberGroupStoreBase.search')).value;

  late final _$_idGroupAtom = Atom(name: 'BPMemberGroupStoreBase._idGroup', context: context);
  ...
  late final _$fetchMemberGroupFutureAtom =
      Atom(name: 'BPMemberGroupStoreBase.fetchMemberGroupFuture', context: context);
  ...
  set fetchMemberGroupFuture(ObservableFuture<List<BPMemberGroup>?> value) {
    _$fetchMemberGroupFutureAtom.reportWrite(value, super.fetchMemberGroupFuture, () {
      super.fetchMemberGroupFuture = value;
    });
  }

  late final _$_membersAtom = Atom(name: 'BPMemberGroupStoreBase._members', context: context);
  ...
  late final _$_perPageAtom = Atom(name: 'BPMemberGroupStoreBase._perPage', context: context);
  ...
  late final _$_initPageAtom = Atom(name: 'BPMemberGroupStoreBase._initPage', context: context);
  ...
  late final _$_nextPageAtom = Atom(name: 'BPMemberGroupStoreBase._nextPage', context: context);
  ...
  late final _$_canLoadMoreAtom = Atom(name: 'BPMemberGroupStoreBase._canLoadMore', context: context);
  ...
  late final _$_includeAtom = Atom(name: 'BPMemberGroupStoreBase._include', context: context);
  ...
  late final _$_excludeAtom = Atom(name: 'BPMemberGroupStoreBase._exclude', context: context);
  ...
  late final _$_searchAtom = Atom(name: 'BPMemberGroupStoreBase._search', context: context);
  ...
  late final _$_excludeAdminsAtom = Atom(name: 'BPMemberGroupStoreBase._excludeAdmins', context: context);
  ...
  late final _$pendingAtom = Atom(name: 'BPMemberGroupStoreBase.pending', context: context);
  ...
  late final _$getMemberGroupsAsyncAction = AsyncAction('BPMemberGroupStoreBase.getMemberGroups', context: context);

  @override
  Future<List<BPMemberGroup>> getMemberGroups({bool cancelPrevious = false}) {
    return _$getMemberGroupsAsyncAction.run(() => super.getMemberGroups(cancelPrevious: cancelPrevious));
  }
  ...
  @override
  Future<void> refresh() {
    final _$actionInfo = _$BPMemberGroupStoreBaseActionController.startAction(name: 'BPMemberGroupStoreBase.refresh');
    try {
  ...
  void onChanged({List<BPMemberGroup>? include, List<BPMemberGroup>? exclude, String? search}) {
    final _$actionInfo = _$BPMemberGroupStoreBaseActionController.startAction(name: 'BPMemberGroupStoreBase.onChanged');
    try {
      return super.onChanged(include: include, exclude: exclude, search: search);
    } finally {
      _$BPMemberGroupStoreBaseActionController.endAction(_$actionInfo);
    }
  }
