...
mixin _$BPConversationStore on BPConversationStoreBase, Store {
  ...
  @override
  bool get loading =>
      (_$loadingComputed ??= Computed<bool>(() => super.loading, name: 'BPConversationStoreBase.loading')).value;
  Computed<ObservableList<BPConversation>>? _$conversationsComputed;

  @override
  ObservableList<BPConversation> get conversations =>
      (_$conversationsComputed ??= Computed<ObservableList<BPConversation>>(() => super.conversations,
  ...
  @override
  int get nextPage =>
      (_$nextPageComputed ??= Computed<int>(() => super.nextPage, name: 'BPConversationStoreBase.nextPage')).value;
  Computed<bool>? _$canLoadMoreComputed;

  @override
  bool get canLoadMore =>
      (_$canLoadMoreComputed ??= Computed<bool>(() => super.canLoadMore, name: 'BPConversationStoreBase.canLoadMore'))
          .value;
  Computed<int>? _$perPageComputed;

  @override
  int get perPage =>
      (_$perPageComputed ??= Computed<int>(() => super.perPage, name: 'BPConversationStoreBase.perPage')).value;
  Computed<String>? _$boxComputed;

  @override
  String get box => (_$boxComputed ??= Computed<String>(() => super.box, name: 'BPConversationStoreBase.box')).value;

  late final _$fetchConversationsFutureAtom =
      Atom(name: 'BPConversationStoreBase.fetchConversationsFuture', context: context);
  ...
  set fetchConversationsFuture(ObservableFuture<List<BPConversation>?> value) {
    _$fetchConversationsFutureAtom.reportWrite(value, super.fetchConversationsFuture, () {
      super.fetchConversationsFuture = value;
    });
  }

  late final _$_conversationsAtom = Atom(name: 'BPConversationStoreBase._conversations', context: context);
  ...
  late final _$_boxAtom = Atom(name: 'BPConversationStoreBase._box', context: context);
  ...
  late final _$_perPageAtom = Atom(name: 'BPConversationStoreBase._perPage', context: context);
  ...
  late final _$_nextPageAtom = Atom(name: 'BPConversationStoreBase._nextPage', context: context);
  ...
  late final _$_canLoadMoreAtom = Atom(name: 'BPConversationStoreBase._canLoadMore', context: context);
  ...
  late final _$pendingAtom = Atom(name: 'BPConversationStoreBase.pending', context: context);
  ...
  late final _$getConversationsAsyncAction = AsyncAction('BPConversationStoreBase.getConversations', context: context);
  ...
  @override
  Future<void> refresh() {
    final _$actionInfo = _$BPConversationStoreBaseActionController.startAction(name: 'BPConversationStoreBase.refresh');
    try {
  ...
  void onChanged({String? box}) {
    final _$actionInfo =
        _$BPConversationStoreBaseActionController.startAction(name: 'BPConversationStoreBase.onChanged');
    try {
