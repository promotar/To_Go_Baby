...
class _BMMessageChatScreenState extends State<BMMessageChatScreen>
  ...
  void didChangeDependencies() {
    ...
    _chatStore = BMChatStore(widget.store!.requestHelper, conversation: widget.conversation)..getChat();
          ...
          child: Column(
            ...
            children: [
              ...
              if (widget.conversation.participantsCount != null && widget.conversation.participantsCount! > 2)
                Text(translate("bm_participants_count", {"count": "${widget.conversation.participantsCount}"}),
