...
mixin _$BMConversationStore on BMConversationStoreBase, Store {
  ...
  @override
  bool get loading =>
      (_$loadingComputed ??= Computed<bool>(() => super.loading, name: 'BMConversationStoreBase.loading')).value;
  Computed<ObservableList<BMConversation>>? _$conversationsComputed;

  @override
  ObservableList<BMConversation> get conversations =>
      (_$conversationsComputed ??= Computed<ObservableList<BMConversation>>(() => super.conversations,
              name: 'BMConversationStoreBase.conversations'))
          .value;
  Computed<bool>? _$enableRealtimeComputed;

  @override
  bool get enableRealtime => (_$enableRealtimeComputed ??=
          Computed<bool>(() => super.enableRealtime, name: 'BMConversationStoreBase.enableRealtime'))
      .value;

  late final _$fetchConversationsFutureAtom =
      Atom(name: 'BMConversationStoreBase.fetchConversationsFuture', context: context);
  ...
  late final _$_conversationsAtom = Atom(name: 'BMConversationStoreBase._conversations', context: context);
  ...
  late final _$_pendingAtom = Atom(name: 'BMConversationStoreBase._pending', context: context);
  ...
  late final _$_enableRealtimeAtom = Atom(name: 'BMConversationStoreBase._enableRealtime', context: context);
  ...
  late final _$getConversationsAsyncAction = AsyncAction('BMConversationStoreBase.getConversations', context: context);

  @override
  Future<List<BMConversation>?> getConversations([bool enableRealtime = false]) {
    return _$getConversationsAsyncAction.run(() => super.getConversations(enableRealtime));
  }
