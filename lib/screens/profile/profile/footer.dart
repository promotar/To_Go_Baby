...
class Footer extends StatelessWidget with Utility {
  final String? copyright;
  final List? socials;

  const Footer({Key? key, this.copyright, this.socials}) : super(key: key);
  ...
  Widget buildItem({
    ...
    return Padding(
      padding: EdgeInsetsDirectional.only(start: index != 0 ? itemPaddingMedium : 0),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: Row(
        children: [
          Expanded(child: Text(copyright!, style: theme.textTheme.bodySmall)),
