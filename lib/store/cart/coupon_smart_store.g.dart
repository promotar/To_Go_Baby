...
mixin _$CouponSmartStore on CouponSmartBase, Store {
  ...
  bool get loadingCoupon =>
      (_$loadingCouponComputed ??= Computed<bool>(() => super.loadingCoupon, name: 'CouponSmartBase.loadingCoupon'))
          .value;
  Computed<List<Coupon>>? _$dataComputed;

  @override
  List<Coupon> get data =>
      (_$dataComputed ??= Computed<List<Coupon>>(() => super.data, name: 'CouponSmartBase.data')).value;

  late final _$_loadingCouponAtom = Atom(name: 'CouponSmartBase._loadingCoupon', context: context);
  ...
  late final _$_dataAtom = Atom(name: 'CouponSmartBase._data', context: context);
  ...
  late final _$getCouponsAsyncAction = AsyncAction('CouponSmartBase.getCoupons', context: context);
