...
mixin _$WishListStore on WishListStoreBase, Store {
  ...
  ObservableList<String> get data =>
      (_$dataComputed ??= Computed<ObservableList<String>>(() => super.data, name: 'WishListStoreBase.data')).value;
  Computed<int>? _$countComputed;

  @override
  int get count => (_$countComputed ??= Computed<int>(() => super.count, name: 'WishListStoreBase.count')).value;
  Computed<ObservableList<dynamic>>? _$dataWishlistProductComputed;

  @override
  ObservableList<dynamic> get dataWishlistProduct =>
      (_$dataWishlistProductComputed ??= Computed<ObservableList<dynamic>>(() => super.dataWishlistProduct,
  ...
  bool? get enableWishlistPlugin => (_$enableWishlistPluginComputed ??=
          Computed<bool?>(() => super.enableWishlistPlugin, name: 'WishListStoreBase.enableWishlistPlugin'))
      .value;

  late final _$_dataAtom = Atom(name: 'WishListStoreBase._data', context: context);
  ...
  late final _$fetchProductsFutureAtom = Atom(name: 'WishListStoreBase.fetchProductsFuture', context: context);
  ...
  late final _$_dataWishlistProductAtom = Atom(name: 'WishListStoreBase._dataWishlistProduct', context: context);
  ...
  late final _$offsetPageAtom = Atom(name: 'WishListStoreBase.offsetPage', context: context);
  ...
  late final _$nxPageAtom = Atom(name: 'WishListStoreBase.nxPage', context: context);
  ...
  late final _$countPageAtom = Atom(name: 'WishListStoreBase.countPage', context: context);
  ...
  late final _$_enableWishlistPluginAtom = Atom(name: 'WishListStoreBase._enableWishlistPlugin', context: context);
  ...
  late final _$addWishListAsyncAction = AsyncAction('WishListStoreBase.addWishList', context: context);
  ...
  Future<void> getDataWishlistPlugin() {
    return _$getDataWishlistPluginAsyncAction.run(() => super.getDataWishlistPlugin());
  }

  late final _$getWishlistByUserAsyncAction = AsyncAction('WishListStoreBase.getWishlistByUser', context: context);

  @override
  Future<dynamic> getWishlistByUser(String id) {
    return _$getWishlistByUserAsyncAction.run(() => super.getWishlistByUser(id));
  }

  late final _$addWishlistProductShareKeyAsyncAction =
      AsyncAction('WishListStoreBase.addWishlistProductShareKey', context: context);

  @override
  Future<void> addWishlistProductShareKey({required String shareKey, required int productId}) {
    return _$addWishlistProductShareKeyAsyncAction
        .run(() => super.addWishlistProductShareKey(shareKey: shareKey, productId: productId));
  }
  ...
  Future<void> removeWishlistProduct({required int productId}) {
    return _$removeWishlistProductAsyncAction.run(() => super.removeWishlistProduct(productId: productId));
  }

  late final _$WishListStoreBaseActionController = ActionController(name: 'WishListStoreBase', context: context);

  @override
  void setWishlistPlugin(bool value) {
    final _$actionInfo = _$WishListStoreBaseActionController.startAction(name: 'WishListStoreBase.setWishlistPlugin');
    try {
  ...
  void updateWishList(List<String> newWishlist) {
    final _$actionInfo = _$WishListStoreBaseActionController.startAction(name: 'WishListStoreBase.updateWishList');
    try {
