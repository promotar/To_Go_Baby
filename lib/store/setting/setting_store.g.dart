...
mixin _$SettingStore on SettingStoreBase, Store {
  ...
  @override
  bool get darkMode =>
      (_$darkModeComputed ??= Computed<bool>(() => super.darkMode, name: 'SettingStoreBase.darkMode')).value;
  Computed<String>? _$themeModeKeyComputed;

  @override
  String get themeModeKey =>
      (_$themeModeKeyComputed ??= Computed<String>(() => super.themeModeKey, name: 'SettingStoreBase.themeModeKey'))
          .value;
  Computed<String>? _$languageKeyComputed;

  @override
  String get languageKey =>
      (_$languageKeyComputed ??= Computed<String>(() => super.languageKey, name: 'SettingStoreBase.languageKey')).value;
  Computed<String>? _$imageKeyComputed;

  @override
  String get imageKey =>
      (_$imageKeyComputed ??= Computed<String>(() => super.imageKey, name: 'SettingStoreBase.imageKey')).value;
  Computed<String>? _$localeComputed;

  @override
  String get locale =>
      (_$localeComputed ??= Computed<String>(() => super.locale, name: 'SettingStoreBase.locale')).value;
  Computed<ObservableList<Language>>? _$supportedLanguagesComputed;

  @override
  ObservableList<Language> get supportedLanguages =>
      (_$supportedLanguagesComputed ??= Computed<ObservableList<Language>>(() => super.supportedLanguages,
  ...
  @override
  bool get loading =>
      (_$loadingComputed ??= Computed<bool>(() => super.loading, name: 'SettingStoreBase.loading')).value;
  Computed<PersistHelper>? _$persistHelperComputed;

  @override
  PersistHelper get persistHelper => (_$persistHelperComputed ??=
          Computed<PersistHelper>(() => super.persistHelper, name: 'SettingStoreBase.persistHelper'))
      .value;
  Computed<RequestHelper>? _$requestHelperComputed;

  @override
  RequestHelper get requestHelper => (_$requestHelperComputed ??=
          Computed<RequestHelper>(() => super.requestHelper, name: 'SettingStoreBase.requestHelper'))
      .value;
  Computed<String?>? _$defaultCurrencyComputed;

  @override
  String? get defaultCurrency => (_$defaultCurrencyComputed ??=
          Computed<String?>(() => super.defaultCurrency, name: 'SettingStoreBase.defaultCurrency'))
      .value;
  Computed<String?>? _$currencyComputed;

  @override
  String? get currency =>
      (_$currencyComputed ??= Computed<String?>(() => super.currency, name: 'SettingStoreBase.currency')).value;
  Computed<bool>? _$isCurrencyChangedComputed;

  @override
  bool get isCurrencyChanged => (_$isCurrencyChangedComputed ??=
          Computed<bool>(() => super.isCurrencyChanged, name: 'SettingStoreBase.isCurrencyChanged'))
      .value;
  ...
  ObservableMap<String, dynamic> get currencies => (_$currenciesComputed ??=
          Computed<ObservableMap<String, dynamic>>(() => super.currencies, name: 'SettingStoreBase.currencies'))
      .value;
  Computed<String?>? _$checkoutUrlComputed;

  @override
  String? get checkoutUrl =>
      (_$checkoutUrlComputed ??= Computed<String?>(() => super.checkoutUrl, name: 'SettingStoreBase.checkoutUrl'))
          .value;
  Computed<DataScreen?>? _$dataComputed;

  @override
  DataScreen? get data =>
      (_$dataComputed ??= Computed<DataScreen?>(() => super.data, name: 'SettingStoreBase.data')).value;
  Computed<bool>? _$enableGetStartComputed;

  @override
  bool get enableGetStart =>
      (_$enableGetStartComputed ??= Computed<bool>(() => super.enableGetStart, name: 'SettingStoreBase.enableGetStart'))
          .value;
  Computed<bool>? _$enableSelectLanguageComputed;

  @override
  bool get enableSelectLanguage => (_$enableSelectLanguageComputed ??=
          Computed<bool>(() => super.enableSelectLanguage, name: 'SettingStoreBase.enableSelectLanguage'))
      .value;
  Computed<bool>? _$enableAllowLocationComputed;

  @override
  bool get enableAllowLocation => (_$enableAllowLocationComputed ??=
          Computed<bool>(() => super.enableAllowLocation, name: 'SettingStoreBase.enableAllowLocation'))
      .value;
  Computed<bool>? _$enableUsingBiometricComputed;

  @override
  bool get enableUsingBiometric => (_$enableUsingBiometricComputed ??=
          Computed<bool>(() => super.enableUsingBiometric, name: 'SettingStoreBase.enableUsingBiometric'))
      .value;

  late final _$_supportedLanguagesAtom = Atom(name: 'SettingStoreBase._supportedLanguages', context: context);
  ...
  late final _$_langAtom = Atom(name: 'SettingStoreBase._lang', context: context);
  ...
  late final _$_localeAtom = Atom(name: 'SettingStoreBase._locale', context: context);
  ...
  late final _$_darkModeAtom = Atom(name: 'SettingStoreBase._darkMode', context: context);
  ...
  late final _$_loadingAtom = Atom(name: 'SettingStoreBase._loading', context: context);
  ...
  late final _$_dataAtom = Atom(name: 'SettingStoreBase._data', context: context);
  ...
  late final _$_currenciesAtom = Atom(name: 'SettingStoreBase._currencies', context: context);
  ...
  late final _$_defaultCurrencyAtom = Atom(name: 'SettingStoreBase._defaultCurrency', context: context);
  ...
  late final _$_currencyAtom = Atom(name: 'SettingStoreBase._currency', context: context);
  ...
  late final _$_checkoutUrlAtom = Atom(name: 'SettingStoreBase._checkoutUrl', context: context);
  ...
  late final _$_enableGetStartAtom = Atom(name: 'SettingStoreBase._enableGetStart', context: context);
  ...
  late final _$_enableSelectLanguageAtom = Atom(name: 'SettingStoreBase._enableSelectLanguage', context: context);
  ...
  late final _$_enableAllowLocationAtom = Atom(name: 'SettingStoreBase._enableAllowLocation', context: context);
  ...
  late final _$_enableUsingBiometricAtom = Atom(name: 'SettingStoreBase._enableUsingBiometric', context: context);
  ...
  late final _$changeLanguageAsyncAction = AsyncAction('SettingStoreBase.changeLanguage', context: context);
  ...
  late final _$changeCurrencyAsyncAction = AsyncAction('SettingStoreBase.changeCurrency', context: context);
  ...
  late final _$setDarkModeAsyncAction = AsyncAction('SettingStoreBase.setDarkMode', context: context);
  ...
  late final _$closeGetStartAsyncAction = AsyncAction('SettingStoreBase.closeGetStart', context: context);
  ...
  late final _$closeSelectLanguageAsyncAction = AsyncAction('SettingStoreBase.closeSelectLanguage', context: context);
  ...
  late final _$closeAllowLocationAsyncAction = AsyncAction('SettingStoreBase.closeAllowLocation', context: context);
  ...
  late final _$setBiometricAsyncAction = AsyncAction('SettingStoreBase.setBiometric', context: context);

  @override
  Future<void> setBiometric({required bool value}) {
    return _$setBiometricAsyncAction.run(() => super.setBiometric(value: value));
  }

  late final _$getBiometricAsyncAction = AsyncAction('SettingStoreBase.getBiometric', context: context);
  ...
  late final _$getSettingAsyncAction = AsyncAction('SettingStoreBase.getSetting', context: context);
  ...
  late final _$SettingStoreBaseActionController = ActionController(name: 'SettingStoreBase', context: context);

  @override
  void setTab(String? tab) {
    final _$actionInfo = _$SettingStoreBaseActionController.startAction(name: 'SettingStoreBase.setTab');
    try {
  ...
  @override
  dynamic removeTab() {
    final _$actionInfo = _$SettingStoreBaseActionController.startAction(name: 'SettingStoreBase.removeTab');
    try {
  ...
  void setSetting(dynamic json) {
    final _$actionInfo = _$SettingStoreBaseActionController.startAction(name: 'SettingStoreBase.setSetting');
    try {
