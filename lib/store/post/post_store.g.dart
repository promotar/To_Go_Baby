...
mixin _$PostStore on PostStoreBase, Store {
  ...
  @override
  String get postType =>
      (_$postTypeComputed ??= Computed<String>(() => super.postType, name: 'PostStoreBase.postType')).value;
  ...
  PostCategoryStore? get postCategoryStore => (_$postCategoryStoreComputed ??=
          Computed<PostCategoryStore?>(() => super.postCategoryStore, name: 'PostStoreBase.postCategoryStore'))
      .value;
  Computed<PostTagStore?>? _$postTagStoreComputed;

  @override
  PostTagStore? get postTagStore =>
      (_$postTagStoreComputed ??= Computed<PostTagStore?>(() => super.postTagStore, name: 'PostStoreBase.postTagStore'))
          .value;
  Computed<bool>? _$loadingComputed;

  @override
  bool get loading => (_$loadingComputed ??= Computed<bool>(() => super.loading, name: 'PostStoreBase.loading')).value;
  Computed<int>? _$nextPageComputed;

  @override
  int get nextPage =>
      (_$nextPageComputed ??= Computed<int>(() => super.nextPage, name: 'PostStoreBase.nextPage')).value;
  Computed<ObservableList<Post>>? _$postsComputed;

  @override
  ObservableList<Post> get posts =>
      (_$postsComputed ??= Computed<ObservableList<Post>>(() => super.posts, name: 'PostStoreBase.posts')).value;
  Computed<bool>? _$canLoadMoreComputed;

  @override
  bool get canLoadMore =>
      (_$canLoadMoreComputed ??= Computed<bool>(() => super.canLoadMore, name: 'PostStoreBase.canLoadMore')).value;
  Computed<Map<dynamic, dynamic>>? _$sortComputed;

  @override
  Map<dynamic, dynamic> get sort =>
      (_$sortComputed ??= Computed<Map<dynamic, dynamic>>(() => super.sort, name: 'PostStoreBase.sort')).value;
  Computed<int>? _$perPageComputed;

  @override
  int get perPage => (_$perPageComputed ??= Computed<int>(() => super.perPage, name: 'PostStoreBase.perPage')).value;
  Computed<ObservableList<PostTag?>>? _$tagSelectedComputed;

  @override
  ObservableList<PostTag?> get tagSelected => (_$tagSelectedComputed ??=
          Computed<ObservableList<PostTag?>>(() => super.tagSelected, name: 'PostStoreBase.tagSelected'))
      .value;

  late final _$fetchPostsFutureAtom = Atom(name: 'PostStoreBase.fetchPostsFuture', context: context);
  ...
  late final _$_postsAtom = Atom(name: 'PostStoreBase._posts', context: context);
  ...
  late final _$successAtom = Atom(name: 'PostStoreBase.success', context: context);
  ...
  late final _$_postTypeAtom = Atom(name: 'PostStoreBase._postType', context: context);
  ...
  late final _$_perPageAtom = Atom(name: 'PostStoreBase._perPage', context: context);
  ...
  late final _$_nextPageAtom = Atom(name: 'PostStoreBase._nextPage', context: context);
  ...
  late final _$_canLoadMoreAtom = Atom(name: 'PostStoreBase._canLoadMore', context: context);
  ...
  late final _$_searchAtom = Atom(name: 'PostStoreBase._search', context: context);
  ...
  late final _$_categorySelectedAtom = Atom(name: 'PostStoreBase._categorySelected', context: context);
  ...
  late final _$_tagSelectedAtom = Atom(name: 'PostStoreBase._tagSelected', context: context);
  ...
  late final _$_authorsAtom = Atom(name: 'PostStoreBase._authors', context: context);
  ...
  late final _$_includeAtom = Atom(name: 'PostStoreBase._include', context: context);
  ...
  late final _$_excludeAtom = Atom(name: 'PostStoreBase._exclude', context: context);
  ...
  late final _$pendingAtom = Atom(name: 'PostStoreBase.pending', context: context);
  ...
  late final _$getPostsAsyncAction = AsyncAction('PostStoreBase.getPosts', context: context);
  ...
  late final _$searchAsyncAction = AsyncAction('PostStoreBase.search', context: context);
  ...
  late final _$PostStoreBaseActionController = ActionController(name: 'PostStoreBase', context: context);

  @override
  Future<void> refresh() {
    final _$actionInfo = _$PostStoreBaseActionController.startAction(name: 'PostStoreBase.refresh');
    try {
  ...
  void onChanged(
      ...
      bool silent = false}) {
    final _$actionInfo = _$PostStoreBaseActionController.startAction(name: 'PostStoreBase.onChanged');
    try {
