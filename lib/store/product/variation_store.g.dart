...
mixin _$VariationStore on VariationStoreBase, Store {
  ...
  ObservableMap<String, dynamic>? get data =>
      (_$dataComputed ??= Computed<ObservableMap<String, dynamic>?>(() => super.data, name: 'VariationStoreBase.data'))
          .value;
  Computed<ObservableMap<String?, String?>>? _$selectedComputed;

  @override
  ObservableMap<String?, String?> get selected => (_$selectedComputed ??=
          Computed<ObservableMap<String?, String?>>(() => super.selected, name: 'VariationStoreBase.selected'))
      .value;
  Computed<bool>? _$loadingComputed;

  @override
  bool get loading =>
      (_$loadingComputed ??= Computed<bool>(() => super.loading, name: 'VariationStoreBase.loading')).value;
  Computed<bool>? _$canAddToCartComputed;

  @override
  bool get canAddToCart =>
      (_$canAddToCartComputed ??= Computed<bool>(() => super.canAddToCart, name: 'VariationStoreBase.canAddToCart'))
          .value;
  Computed<Map<String, dynamic>>? _$findVariationComputed;

  @override
  Map<String, dynamic> get findVariation => (_$findVariationComputed ??=
          Computed<Map<String, dynamic>>(() => super.findVariation, name: 'VariationStoreBase.findVariation'))
      .value;
  Computed<Product?>? _$productVariationComputed;

  @override
  Product? get productVariation => (_$productVariationComputed ??=
          Computed<Product?>(() => super.productVariation, name: 'VariationStoreBase.productVariation'))
      .value;

  late final _$_langAtom = Atom(name: 'VariationStoreBase._lang', context: context);
  ...
  late final _$_currencyAtom = Atom(name: 'VariationStoreBase._currency', context: context);
  ...
  late final _$_productIdAtom = Atom(name: 'VariationStoreBase._productId', context: context);
  ...
  late final _$_manageStockParentAtom = Atom(name: 'VariationStoreBase._manageStockParent', context: context);
  ...
  late final _$_selectedAtom = Atom(name: 'VariationStoreBase._selected', context: context);
  ...
  late final _$_dataAtom = Atom(name: 'VariationStoreBase._data', context: context);
  ...
  late final _$_loadingAtom = Atom(name: 'VariationStoreBase._loading', context: context);
  ...
  late final _$getVariationAsyncAction = AsyncAction('VariationStoreBase.getVariation', context: context);

  @override
  Future<void> getVariation(List<Map<String, dynamic>>? defaultAttributes) {
    return _$getVariationAsyncAction.run(() => super.getVariation(defaultAttributes));
  }

  late final _$VariationStoreBaseActionController = ActionController(name: 'VariationStoreBase', context: context);

  @override
  void selectTerm({String? key, String? value}) {
    final _$actionInfo = _$VariationStoreBaseActionController.startAction(name: 'VariationStoreBase.selectTerm');
    try {
  ...
  @override
  void clear() {
    final _$actionInfo = _$VariationStoreBaseActionController.startAction(name: 'VariationStoreBase.clear');
    try {
      return super.clear();
    } finally {
      _$VariationStoreBaseActionController.endAction(_$actionInfo);
  ...
  @override
  dynamic dispose() {
    final _$actionInfo = _$VariationStoreBaseActionController.startAction(name: 'VariationStoreBase.dispose');
    try {
