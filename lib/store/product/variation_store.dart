...
abstract class VariationStoreBase with Store {
  ...
  // constructor: ------------------------------------------------------------------------------------------------------
  VariationStoreBase(this._requestHelper,
      {this.key, int? productId, bool? manageStockParent, String? lang, String? currency}) {
  ...
  Product? get productVariation => findVariation['id'] > 0
      ? Product.fromVariation({
          ...findVariation,
          "manage_stock": findVariation['manage_stock'] == "parent"
              ? _manageStockParent
              : ConvertData.toBoolValue(findVariation['manage_stock'])
        })
      : null;
