...
mixin _$OrderStore on OrderStoreBase, Store {
  ...
  bool get canLoadMore =>
      (_$canLoadMoreComputed ??= Computed<bool>(() => super.canLoadMore, name: 'OrderStoreBase.canLoadMore')).value;
  Computed<bool>? _$loadingComputed;

  @override
  bool get loading => (_$loadingComputed ??= Computed<bool>(() => super.loading, name: 'OrderStoreBase.loading')).value;
  Computed<ObservableList<OrderData>>? _$ordersComputed;

  @override
  ObservableList<OrderData> get orders =>
      (_$ordersComputed ??= Computed<ObservableList<OrderData>>(() => super.orders, name: 'OrderStoreBase.orders'))
          .value;
  Computed<ObservableList<dynamic>>? _$orderCancelComputed;

  @override
  ObservableList<dynamic> get orderCancel => (_$orderCancelComputed ??=
          Computed<ObservableList<dynamic>>(() => super.orderCancel, name: 'OrderStoreBase.orderCancel'))
      .value;
  Computed<bool>? _$loadingCancelComputed;

  @override
  bool get loadingCancel =>
      (_$loadingCancelComputed ??= Computed<bool>(() => super.loadingCancel, name: 'OrderStoreBase.loadingCancel'))
          .value;

  late final _$fetchOrdersFutureAtom = Atom(name: 'OrderStoreBase.fetchOrdersFuture', context: context);
  ...
  late final _$_ordersAtom = Atom(name: 'OrderStoreBase._orders', context: context);
  ...
  late final _$_orderCancelAtom = Atom(name: 'OrderStoreBase._orderCancel', context: context);
  ...
  late final _$_nextPageAtom = Atom(name: 'OrderStoreBase._nextPage', context: context);
  ...
  late final _$perPageAtom = Atom(name: 'OrderStoreBase.perPage', context: context);
  ...
  late final _$_customerAtom = Atom(name: 'OrderStoreBase._customer', context: context);
  ...
  late final _$_canLoadMoreAtom = Atom(name: 'OrderStoreBase._canLoadMore', context: context);
  ...
  late final _$_loadingCancelAtom = Atom(name: 'OrderStoreBase._loadingCancel', context: context);
  ...
  late final _$searchAtom = Atom(name: 'OrderStoreBase.search', context: context);
  ...
  late final _$getOrdersAsyncAction = AsyncAction('OrderStoreBase.getOrders', context: context);
  ...
  late final _$getCancelOrderAsyncAction = AsyncAction('OrderStoreBase.getCancelOrder', context: context);
  ...
  late final _$postCancelOrderAsyncAction = AsyncAction('OrderStoreBase.postCancelOrder', context: context);

  @override
  Future<void> postCancelOrder({Map<String, dynamic>? dataCancel}) {
    return _$postCancelOrderAsyncAction.run(() => super.postCancelOrder(dataCancel: dataCancel));
  }

  late final _$OrderStoreBaseActionController = ActionController(name: 'OrderStoreBase', context: context);

  @override
  Future<void> refresh() {
    final _$actionInfo = _$OrderStoreBaseActionController.startAction(name: 'OrderStoreBase.refresh');
    try {
